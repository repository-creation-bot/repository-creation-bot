...
function handleIssueComment(eventData, token, orgAdmins) {
...
const core = __importStar(__nccwpck_require__(186));
function handleIssues(eventData) {
    return __awaiter(this, void 0, void 0, function* () {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(186));
const issues_1 = __nccwpck_require__(962);
const issue_comments_1 = __nccwpck_require__(881);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            switch (eventName) {
                case 'issues':
                    yield (0, issues_1.handleIssues)(eventData);
                    break;
                case 'issue_comment':
                    yield (0, issue_comments_1.handleIssueComment)(eventData, token, orgAdmins);
                    break;
            }
        }
        catch (error) {
